...
# Prefer ZLIB_ROOT / CMAKE_PREFIX_PATH over PKG_CONFIG_PATH (Windows-safe).
...
list(APPEND _dailyboy_png_args
    ...
    -DZLIB_INCLUDE_DIR=${DAILYBOY_ZLIB_PREFIX}/include
    -DCMAKE_PREFIX_PATH=${DAILYBOY_ZLIB_PREFIX}
)
if(WIN32)
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
        list(APPEND _dailyboy_png_args -DZLIB_LIBRARY=${DAILYBOY_ZLIB_PREFIX}/lib/zlibd.lib)
    else()
        list(APPEND _dailyboy_png_args -DZLIB_LIBRARY=${DAILYBOY_ZLIB_PREFIX}/lib/zlib.lib)
    endif()
endif()
if(MSVC)
