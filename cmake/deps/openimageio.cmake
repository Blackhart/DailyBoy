...
set(_dailyboy_oiio_prefix_path
    "${DAILYBOY_ZLIB_PREFIX}|${DAILYBOY_JPEG_TURBO_PREFIX}|${DAILYBOY_LIBPNG_PREFIX}|${DAILYBOY_LIBTIFF_PREFIX}|${DAILYBOY_LIBRAW_PREFIX}|${DAILYBOY_LIBDE265_PREFIX}|${DAILYBOY_LIBHEIF_PREFIX}|${DAILYBOY_X264_PREFIX}|${DAILYBOY_X265_PREFIX}|${DAILYBOY_FFMPEG_PREFIX}|${DAILYBOY_TBB_PREFIX}|${DAILYBOY_OCIO_PREFIX}"
)
...
message(
    STATUS
    "deps: OpenImageIO ${DAILYBOY_OPENIMAGEIO_GIT_TAG} "
    "(EXR, TIFF, OCIO, JPEG, PNG, RAW, FFmpeg, TBB, HEIF, FreeType)"
)
