...
/*!
 * \brief Writes RGB frames to a QuickTime MOV as libx264.
 */
class H264Writer : public VideoWriter {
 public:
  H264Writer();
  ~H264Writer() override;

  H264Writer(const H264Writer&) = delete;
  H264Writer& operator=(const H264Writer&) = delete;
